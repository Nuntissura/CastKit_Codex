# Technical Specification — CastKit Codex (CKC) — v00.024
...
- Location: Electron `app.getPath('userData')` (Windows: typically `%APPDATA%\\castkit-codex\\ckc-config.json`)
- Default `libraryRoot`: `%USERPROFILE%\\Documents\\CastKit Codex Library`
