...
## Current focus
- Current: WP-0104 shipped (block-list inline editor; commit `d667408`). 167 tests pass. Live verified end-to-end on Aeri (`CHAR-000003`) `Side_Hustles`. Spec v00.067 → v00.068 (also retroactive v00.067 entry for WP-0103). Manual v2026-05-06.wp-0104. Test suite F1.7 RESOLVED.
- Last shipped releases: v0.2.9 (WP-0099 + WP-0100 packaged build; tag pushed 2026-05-06).
