...
- J22. WP-0115 multi-rig workspace gate: `rig_workspace_tabs.test.js`, `posekit_ui_static.test.js`, and `automation_manual_consistency.test.js` pass; `listOpenRigs`, `openRigWorkspace`, `setActiveRig`, `closeRigWorkspace`, and `reorderOpenRigWorkspaces` are wired through backend automation/manual/preload; closing a workspace tab leaves `Rig` rows and image assets intact.
- J23. WP-0115 live visual/backend gate: import two images from `CKC_GOV/references/posekit_samples/`, create two rigs, open both rig workspaces, open Pose, verify two workspace tabs render, active yaw/pitch/roll follows the active rig, verify per-tab Tools/Markers panel state restores, click the active tab close button through `clickElement`, verify one tab remains active and both Rig rows still exist. Latest pass: 2026-05-07, character `char_c2fcc4dcd3f6316682239f968df787ed`, rigs `rig_69deb074d2fc64941d0f954325704b07` and `rig_4b3063cf3132a41077cc87ed907eec9d`, captures `CKC_GOV/targets/CKC/automation_captures/2026-05-07_200417170Z_no_session_wp-0115-final-two-rig-tabs.png` and `2026-05-07_200417510Z_no_session_wp-0115-final-after-close.png`.
- J24. Remaining release gate: packaged build smoke repeats J14, J15, J17, J19, J21, and J23 from the packaged app.
...
- Product coverage: `IdentityProfile` table, per-character `images/identity/` and `identity_profiles/` folders, backend CRUD, IPC/preload/automation/manual, Pose Identity panel, Workflow identity selector, replay bridge injection, and ComfyUI bridge optional identity sockets.
- Tests passed:
  - `node --test test/identity_profile_crud.test.js test/identity_profile_replay_injection.test.js test/backend_posekit_workflow.test.js test/posekit_ui_static.test.js test/automation_manual_consistency.test.js`
  - `npx tsc --noEmit`
- Live automation passed with `D:/Projects/LLM projects/OpenRepose/test_material/image_samples/1085406391.jpg`: MediaPipe rig `rig_241ea5569a419fdd4395eff89d70386e`, profile `idp_562fb122ff50282c7f697a30ae362fc2`, crop `images/identity/d7f57768109c90a0.png`, captures `2026-05-07_185915473Z_no_session_wp-0111-identity-panel.png` and `2026-05-07_185916851Z_no_session_wp-0111-workflow-identity-dropdown.png`.
