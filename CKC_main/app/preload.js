...
contextBridge.exposeInMainWorld('ckc', {
    ...
    resetPreferences: () => ipcRenderer.invoke('ckc:resetPreferences'),
    requestFullReset: () => ipcRenderer.invoke('ckc:requestFullReset'),
    listOrphanManifests: (params) => ipcRenderer.invoke('ckc:listOrphanManifests', params),
    adoptOrphanImages: (params) => ipcRenderer.invoke('ckc:adoptOrphanImages', params),
    ...
    listOpenRigs: (params) => ipcRenderer.invoke('ckc:listOpenRigs', params),
    openRigWorkspace: (params) => ipcRenderer.invoke('ckc:openRigWorkspace', params),
    setActiveRig: (params) => ipcRenderer.invoke('ckc:setActiveRig', params),
    closeRigWorkspace: (params) => ipcRenderer.invoke('ckc:closeRigWorkspace', params),
    reorderOpenRigWorkspaces: (params) => ipcRenderer.invoke('ckc:reorderOpenRigWorkspaces', params),
    listIdentityProfiles: (params) => ipcRenderer.invoke('ckc:listIdentityProfiles', params),
    getIdentityProfile: (params) => ipcRenderer.invoke('ckc:getIdentityProfile', params),
    createIdentityProfile: (params) => ipcRenderer.invoke('ckc:createIdentityProfile', params),
    updateIdentityProfile: (params) => ipcRenderer.invoke('ckc:updateIdentityProfile', params),
    deleteIdentityProfile: (params) => ipcRenderer.invoke('ckc:deleteIdentityProfile', params),
    registerComfyUIOutput: (params) => ipcRenderer.invoke('ckc:registerComfyUIOutput', params),
    getWorkflowHistory: (params) => ipcRenderer.invoke('ckc:getWorkflowHistory', params),
    extractPromptFromWorkflow: (params) => ipcRenderer.invoke('ckc:extractPromptFromWorkflow', params),
    replayWorkflow: (params) => ipcRenderer.invoke('ckc:replayWorkflow', params),
    getComfyUIStats: (params) => ipcRenderer.invoke('ckc:getComfyUIStats', params),
