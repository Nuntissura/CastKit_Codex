...
- `docs/CastKit_Codex_Spec_v00.058.md` (mirrored from `CKC_GOV/spec/`)
...
3. **Update spec with every addition**
   - Current spec: `CKC_GOV/spec/CastKit_Codex_Spec_v00.058.md`
   - Mirror into this repo: `docs/CastKit_Codex_Spec_v00.058.md`
